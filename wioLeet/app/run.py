...
wioMoistureStamp = get_wio_sensor_data(NodeProperties.moisture.name, NodeProperties.moisture.value, wio_pete_token)
wioHumidityStamp = get_wio_sensor_data(NodeProperties.humidity.name, NodeProperties.humidity.value, wio1_token)
wioTemperatureStamp = get_wio_sensor_data(NodeProperties.fahrenheit_degree.name, NodeProperties.humidity.value, wio1_token)
